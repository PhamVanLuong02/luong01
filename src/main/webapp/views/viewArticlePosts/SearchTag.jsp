        ...
        <div>
            <nav class="my-4" aria-label="...">
                <ul class="pagination pagination-circle justify-content-center">
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/Post/Tag?tid=${tid}&index=${indexPre}" tabindex="-1" aria-disabled="true">Previous</a>
                    </li>
                    <c:forEach begin="1" end="${EndPage}" var="i">
                        <li class="page-item ">
                            <a  class="${tag==i?"active":" page-link "}"
                                href="${pageContext.request.contextPath}/Post/Tag?tid=${tid}&index=${i}"> ${i}
